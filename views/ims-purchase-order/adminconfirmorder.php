...
?>
<!-- BEGIN PAGE BAR -->
<span id="adminorderconfirm" class="<?php echo Yii::$app->controller->id."/".Yii::$app->controller->action->id;?>"></span>
...
<div class="invoice">
                                    ...
                                    'buttons' => [
                                        'edit' => function ($url, $model3) {
                                            return Html::a('<i class="fa fa-edit"></i>', 
                                                    $url,['value'=>Url::to(['ims-purchase-order/update1','id'=>$model3->ims_purchaseId]),'title'=> Yii::t('app','Edit'),'class'=>'btn btn-circle btn-icon-only purple modalInvoiceedititem']);
    ...
    <div class="row">
        ...
        <div class="col-xs-8 invoice-block">
            ...
            <?= Html::a('Submit Order<i class="fa fa-check"></i>', ['ims-purchase-order/send_to_vendor','id'=>$model->ims_invoicePurchaseno], ['class' => 'btn btn-lg green-meadow hidden-print margin-bottom-5']) ?>
